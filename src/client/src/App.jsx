...
export default function App() {
  ...
  return (
    <BrowserRouter>
      <AppShell wallet={wallet} onCreateWallet={createWallet} onLoadWallet={loadWallet}>
        <Routes>
          ...
          <Route path="/challenges/new" element={<CreateChallenge wallet={wallet} onSuccess={fetchChallenges} />} />
